...
export default function BottomBar({
  ...
  return (
    <div
      className={`h-[15vh] fixed bottom-0 left-0 right-0 text-white flex justify-around items-end py-3 shadow-sm `}
    >
        <div className="w-full h-full relative z-0 border-t-[1px] border-white rounded-3xl">
          <div className="w-full h-full absolute bottom-0 rounded-3xl left-0 bg-[#120606] opacity-70 blur-md"></div>
        </div>
      {/* {activeTab !== "Home" && (
        ${activeTab == "Home" ? "bg-[#120606]" : "rounded-xl"}
      )} */}
